...
(function(global) {
  ...
  function addStock(stock) {
    ...
    const newStock = {
      ...
      name: stock.name,
      ipoPrice: parseFloat(stock.ipoPrice),
  ...
  function addOrder(order) {
    ...
    const newOrder = {
      ...
      sellPrice: order.sellPrice !== undefined ? parseFloat(order.sellPrice) : 0,
  ...
  function updateOrder(id, updatedData) {
    ...
    if (index !== -1) {
      ...
      if (updatedData.sellPrice !== undefined) updatedData.sellPrice = parseFloat(updatedData.sellPrice);
  ...
  function updateTransfer(id, updatedData) {
    ...
    if (index !== -1) {
      if (updatedData.amount !== undefined) updatedData.amount = parseFloat(updatedData.amount);
  ...
  function addDebt(debt) {
    ...
    const newDebt = {
      ...
      paidAmount: debt.paidAmount !== undefined ? parseFloat(debt.paidAmount) : 0,
  ...
  function updateDebt(id, updatedData) {
    ...
    if (index !== -1) {
      if (updatedData.amount !== undefined) updatedData.amount = parseFloat(updatedData.amount);
      if (updatedData.paidAmount !== undefined) updatedData.paidAmount = parseFloat(updatedData.paidAmount);
    ...
    nomineeOrders.forEach(o => {
      ...
      if (o.status === 'allotted' || o.status === 'sold') {
        ...
        if (o.status === 'sold') {
          ...
          totalProfit += (sellVal - allottedVal);
        } else {
